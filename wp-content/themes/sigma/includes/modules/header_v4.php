			...
			<div class="col-md-5">
				...
				<nav>
					...
					<ul class="menu clearfix nav" id="menu-left">
						<?php wp_nav_menu( array( 'theme_location' => 'main_menu4l', 'container_id' => 'navbar-collapse-1',
			...
			<div class="col-md-5">
				...
				<nav>
					<ul class="menu clearfix nav" id="menu-right">
						<?php wp_nav_menu( array( 'theme_location' => 'main_menu4r', 'container_id' => 'navbar-collapse-1',
							'container_class'=>'navbar-collapse collapse navbar-right',
							'menu_class'=>'nav navbar-nav',
							'fallback_cb'=>false, 
							'items_wrap' => '%3$s', 
